...
The processed modelling datasets are provided as assets in the GitHub release `data-v1.0`. The merged Eskom–ERA5 dataset used for exploratory analysis is stored in `data/processed/safer_wind_eskom_era5_merged.csv`.

These files correspond to the final analysis and are included to make the reported manuscript results easy to verify without rerunning the full notebook.
